...
import io.github.kimmking.gateway.filter.impl.NioRequestFilter;
...
public class HttpInboundHandler extends ChannelInboundHandlerAdapter {
    ...
    private final OkhttpOutboundHandler outboundHandler;
    private final Set<HttpRequestFilter> filters;

    public HttpInboundHandler(String proxyServer) {
        this.proxyServer = proxyServer;
        outboundHandler = new OkhttpOutboundHandler(this.proxyServer);
